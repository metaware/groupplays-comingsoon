...
function playVideo(){
	document.getElementById('groupplays-video').load();
	document.getElementById('groupplays-video').play();
}

function pauseVideo(){
	document.getElementById('groupplays-video').pause();
}

$(window).on('hashchange', function(e){
 // Your Code goes here
 	var url = window.location.href;
 	if(url.split("#")[1] == "watch"){
 		playVideo();
 	} else{
 		pauseVideo();
 	}
